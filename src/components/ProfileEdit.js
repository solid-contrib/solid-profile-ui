...
const ProfileEdit = ({ name, email, picUrl, onClickCancel, onClickSubmit }) => (
          ...
          <div className="column col-sm-8">
            <div className="columns">
              <div className="column">
                ...
                <input className="form-input" id="name-input" type="text" value={name} />
              </div>
            </div>
            <div className="columns">
              <div className="column">
                <label className="form-label" htmlFor="email-input">Email</label>
                <input className="form-input" id="email-input" type="text" value={email} />
              </div>
            </div>
            <div className="columns">
              <div className="column">
